...
namespace PhoneKit.Framework.Advertising.Extensions
{
    /// <summary>
    /// Adapts a DependencyObject to provide methods required for generate
    /// a Linq To Tree API
    /// </summary>
    internal class VisualTreeAdapter : ILinqTree<DependencyObject>
    {
...
namespace PhoneKit.Framework.Advertising.Extensions
{
    ...
    internal interface ILinqTree<T>
    {
    ...
    internal static class EnumerableTreeExtensions
    {
        /// <summary>
